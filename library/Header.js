...
export default function Header({ avatar, children }) {
  return (
    <header className="flex justify-between items-center w-full mt-4 mb-8 flex-wrap">
      ...
      <div className="flex flex-col sm:flex-row justify-center md:justify-evenly items-start md:items-center order-last sm:order-1 w-full sm:w-auto sm:flex-grow">
        {children}
      </div>
